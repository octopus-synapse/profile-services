...
export const ENUM_DICTIONARY = {
  ...
  ResumeTemplate: {
    ACADEMIC: { en: 'Academic', 'pt-BR': 'Acadêmico' },
    CREATIVE: { en: 'Creative', 'pt-BR': 'Criativo' },
    EXECUTIVE: { en: 'Executive', 'pt-BR': 'Executivo' },
    MINIMAL: { en: 'Minimal', 'pt-BR': 'Minimalista' },
    MODERN: { en: 'Modern', 'pt-BR': 'Moderno' },
    PROFESSIONAL: { en: 'Professional', 'pt-BR': 'Profissional' },
  ...
  ThemeCategory: {
    ACADEMIC: { en: 'Academic', 'pt-BR': 'Acadêmico' },
    CLASSIC: { en: 'Classic', 'pt-BR': 'Clássico' },
    CREATIVE: { en: 'Creative', 'pt-BR': 'Criativo' },
    EXECUTIVE: { en: 'Executive', 'pt-BR': 'Executivo' },
    MINIMAL: { en: 'Minimal', 'pt-BR': 'Minimalista' },
    MODERN: { en: 'Modern', 'pt-BR': 'Moderno' },
  ...
  ThemeStatus: {
    ...
    PUBLISHED: { en: 'Published', 'pt-BR': 'Publicado' },
    REJECTED: { en: 'Rejected', 'pt-BR': 'Recusado' },
  },
