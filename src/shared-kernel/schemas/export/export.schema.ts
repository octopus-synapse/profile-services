...
export const ExportOutputFormatEnum = z.enum(['pdf', 'docx', 'html', 'json']);
export type ExportOutputFormat = z.infer<typeof ExportOutputFormatEnum>;
