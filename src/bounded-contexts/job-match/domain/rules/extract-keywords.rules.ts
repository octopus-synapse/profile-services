...
const SKILL_VOCAB: readonly string[] = [
  // languages
  "javascript", "typescript", "python", "java", "kotlin", "swift", "golang", "rust", "ruby", "php",
  "c++", "c#", "scala", "elixir", "dart", "objective-c", "bash", "sql", "pl/sql",
  // frontend
  "react", "react native", "next.js", "vue", "vue.js", "nuxt", "angular", "svelte", "sveltekit",
  "redux", "tailwind", "tailwind css", "sass", "webpack", "vite", "html", "css",
  // backend / frameworks
  "node", "node.js", "express", "nestjs", "nest.js", "fastify", "django", "flask", "fastapi",
  "spring", "spring boot", "rails", "laravel", ".net", "asp.net", "graphql", "grpc",
  // mobile
  "android", "ios", "flutter", "expo", "jetpack compose", "swiftui",
  // data / ml
  "pandas", "numpy", "spark", "hadoop", "airflow", "dbt", "kafka", "tensorflow", "pytorch",
  "scikit-learn", "machine learning", "deep learning", "nlp", "data science", "etl", "databricks",
  "snowflake", "tableau", "power bi", "looker",
  // databases
  "postgresql", "postgres", "mysql", "mongodb", "redis", "elasticsearch", "dynamodb", "cassandra",
  "sqlite", "oracle", "sql server", "firestore", "neo4j",
  // cloud / devops
  "aws", "amazon web services", "gcp", "google cloud", "azure", "docker", "kubernetes", "k8s",
  "terraform", "ansible", "jenkins", "github actions", "gitlab ci", "ci/cd", "circleci", "helm",
  "prometheus", "grafana", "datadog", "linux", "nginx", "serverless", "lambda",
  // practices / tools
  "git", "agile", "scrum", "kanban", "jira", "tdd", "microservices", "rest api", "oauth", "jwt",
  "figma", "design system",
  // security
  "owasp", "penetration testing", "appsec", "iam",
];
