...
import { VerifyEmailPort } from '../../application/ports';
...
export class VerifyEmailController {
  constructor(private readonly verifyEmail: VerifyEmailPort) {}
  ...
  @ApiDataResponse(VerifyEmailResponseDto, { description: 'Email verified successfully' })
