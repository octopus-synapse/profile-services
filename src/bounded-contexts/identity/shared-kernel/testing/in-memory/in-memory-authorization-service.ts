/**
 * In-Memory Authorization Service for Testing
 *
 * Provides controllable authorization behavior for tests.
 * Migrated from StubAuthorizationService.
 */
...
export class InMemoryAuthorizationService extends AuthorizationServicePort {
