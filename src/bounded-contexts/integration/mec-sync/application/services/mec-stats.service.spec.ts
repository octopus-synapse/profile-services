...
const buildInstitutionRepo = (
  ...
  ({
    ...
    findAllActiveInstitutions: mock().mockResolvedValue([]),
    ...
    findAllDistinctUfs: mock().mockResolvedValue([]),
    findAllExistingInstitutionCodes: mock().mockResolvedValue(new Set()),
...
const buildCourseRepo = (
  ...
  ({
    ...
    findAllDistinctKnowledgeAreas: mock().mockResolvedValue([]),
    findAllExistingCourseCodes: mock().mockResolvedValue(new Set()),
