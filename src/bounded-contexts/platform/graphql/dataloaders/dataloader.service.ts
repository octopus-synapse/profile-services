...
export class DataLoaderService {
  ...
  createExperiencesLoader(): DataLoader<string, Experience[]> {
    return new DataLoader<string, Experience[]>(async (resumeIds: readonly string[]) => {
  ...
  createEducationsLoader(): DataLoader<string, Education[]> {
    return new DataLoader<string, Education[]>(async (resumeIds: readonly string[]) => {
  ...
  createSkillsLoader(): DataLoader<string, Skill[]> {
    return new DataLoader<string, Skill[]>(async (resumeIds: readonly string[]) => {
