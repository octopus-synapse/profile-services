...
export class AdminMetricsController {
  ...
  async getOverview() {
    ...
    const resumeCreated = metricsJson['resume_created_total'] as
    ...
    const pendingExports = metricsJson['pending_exports_total'] as
      | Record<string, unknown>
      | undefined;
    ...
    const processUptime = metricsJson['process_start_time_seconds'] as
      | Record<string, unknown>
      | undefined;
    const heapUsed = metricsJson['nodejs_heap_size_used_bytes'] as
      | Record<string, unknown>
      | undefined;
