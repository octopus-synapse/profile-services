...
export class AdminTechNichesController {
  ...
  async findAll(
    ...
    return this.bc.listAdminTechNiches.execute({
  ...
  async findOne(@Param('id') id: string) {
    return this.bc.getAdminTechNiche.execute(id);
  }
  ...
  async create(@Body() dto: Record<string, unknown>) {
    return this.bc.createAdminTechNiche.execute(dto);
  }
  ...
  async update(@Param('id') id: string, @Body() dto: Record<string, unknown>) {
    return this.bc.updateAdminTechNiche.execute(id, dto);
  }
  ...
  async remove(@Param('id') id: string) {
    await this.bc.deleteAdminTechNiche.execute(id);
  }
}
