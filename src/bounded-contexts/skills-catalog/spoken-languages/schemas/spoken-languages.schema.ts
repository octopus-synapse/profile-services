...
export type SpokenLanguageCatalogDto = z.infer<typeof SpokenLanguageCatalogSchema>;

export type SpokenLanguagesListDto = z.infer<typeof SpokenLanguagesListSchema>;
