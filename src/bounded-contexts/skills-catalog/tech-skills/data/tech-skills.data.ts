...
function loadTechSkillsData(): TechSkillsDataFile {
  ...
  // Fallback to empty data if file doesn't exist (generated by cron.tech-skills.yml)
  if (!fs.existsSync(srcDataPath) && !fs.existsSync(distDataPath)) {
    return { techAreas: [], techNiches: [] };
  }
