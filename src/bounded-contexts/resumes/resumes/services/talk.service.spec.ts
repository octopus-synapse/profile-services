...
describe('TalkService', () => {
  ...
  describe('CRUD operations', () => {
    ...
    beforeEach(() => {
      ...
      mockTalkRepository.findAllEntitiesForResume.mockResolvedValue({
        data: [mockTalk],
        meta: { page: 1, limit: 20, total: 1, totalPages: 1 },
      });
      mockTalkRepository.createEntityForResume.mockResolvedValue(mockTalk);
      mockTalkRepository.deleteEntityForResume.mockResolvedValue(true);
    });
