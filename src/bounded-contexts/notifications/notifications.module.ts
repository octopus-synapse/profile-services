...
@Module({
  ...
  providers: [
    ...
    },
    {
      ...
      useFactory: (read: FitProfileExpiryReadPort, state: ReminderStatePort) =>
        new EnqueueExpiryRemindersUseCase(read, state),
      inject: [FitProfileExpiryReadPort, ReminderStatePort],
    },
    {
