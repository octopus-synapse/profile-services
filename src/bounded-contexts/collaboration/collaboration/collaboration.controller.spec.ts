...
describe('CollaborationController', () => {
  ...
  let collaborationService: InMemoryCollaborationService;
  ...
  beforeEach(() => {
    collaborationService = new InMemoryCollaborationService();
    controller = new CollaborationController(collaborationService);

    // Seed test data
    collaborationService.seedResume({
      id: 'resume-1',
      userId: 'user-1',
      title: 'Test Resume',
    });
    collaborationService.seedUser({
      id: 'user-2',
      name: 'Jane Doe',
  ...
  describe('getSharedWithMe', () => {
    it('should return resumes shared with user', async () => {
      // Seed a collaborator for user-1 on another resume
      collaborationService.seedResume({
        id: 'resume-2',
        userId: 'other-user',
        title: 'Shared Resume',
      });
      collaborationService.seedCollaborator({
        resumeId: 'resume-2',
        userId: 'user-1',
        role: 'EDITOR',
      });
