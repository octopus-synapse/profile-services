 ...
 *
 * The bundle aggregates pure use-cases plus the two stateful POJO
 * adapters (`pdfImport`, `githubImport`) that the file-driven endpoints
 * (multipart PDF upload + OAuth-backed GitHub import) consume.
 */
