...
export type ParsedResumeDataDto = z.infer<typeof ParsedResumeDataSchema>;

export type ParsedPersonalInfoDto = z.infer<typeof ParsedPersonalInfoSchema>;

export type ParsedSectionDto = z.infer<typeof ParsedSectionSchema>;
