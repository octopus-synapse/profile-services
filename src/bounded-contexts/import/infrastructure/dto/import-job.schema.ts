...
import { ImportStatusEnumSchema } from './import-result.schema';
import { ParsedResumeDataSchema } from './parsed-resume-data.schema';
...
export type ImportSourceEnumDto = z.infer<typeof ImportSourceEnumSchema>;
