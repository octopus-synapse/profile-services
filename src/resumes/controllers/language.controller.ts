...
export class LanguageController {
  ...
  @Get()
  @ApiOperation({ summary: 'Get all languages for a resume' })
  ...
  async findAll(
    ...
    return this.languageService.findAll(resumeId, user.userId, page, limit);
  }
  ...
  async findOne(
    ...
    return this.languageService.findOne(resumeId, id, user.userId);
  }
  ...
  @ApiParam({ name: 'resumeId', description: 'Resume ID' })
  @ApiResponse({ status: 201, type: LanguageResponseDto })
  ...
  async create(
    ...
    return this.languageService.create(resumeId, user.userId, createDto);
  }
  ...
  async update(
    ...
    return this.languageService.update(resumeId, id, user.userId, updateDto);
  }
  ...
  async remove(
    ...
    return this.languageService.remove(resumeId, id, user.userId);
  }
  ...
  @ApiParam({ name: 'resumeId', description: 'Resume ID' })
  @ApiResponse({ status: 200, description: 'Languages reordered' })
  async reorder(
    @Param('resumeId', ParseCuidPipe) resumeId: string,
    @CurrentUser() user: UserPayload,
    @Body() reorderDto: ReorderDto,
  ) {
    return this.languageService.reorder(resumeId, user.userId, reorderDto.ids);
  }
}
