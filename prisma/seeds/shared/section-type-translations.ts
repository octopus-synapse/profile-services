...
export const sectionTypeTranslations: Record<string, SectionTypeTranslations> = {
  work_experience_v1: {
    en: {
      ...
      noDataLabel: "I don't have experience yet",
    ...
    'pt-BR': {
      ...
      label: 'Trabalho',
      noDataLabel: 'Ainda não tenho experiência',
  ...
  education_v1: {
    en: {
      ...
      label: 'Education',
      noDataLabel: "I don't have formal education",
  ...
  skill_set_v1: {
    en: {
      ...
      label: 'Hard Skills',
      noDataLabel: "I'm still learning",
    ...
    'pt-BR': {
      ...
      noDataLabel: 'Ainda estou aprendendo',
  ...
  soft_skill_set_v1: {
    en: {
      ...
      label: 'Soft Skills',
      noDataLabel: 'Nothing to highlight yet',
    ...
    'pt-BR': {
      ...
      noDataLabel: 'Nada a destacar por enquanto',
  ...
  language_v1: {
    en: {
      ...
      label: 'Languages',
      noDataLabel: "I don't have languages",
  ...
  project_v1: {
    en: {
      ...
      label: 'projects',
      noDataLabel: "I don't have projects",
    ...
    'pt-BR': {
      ...
      label: 'projetos',
      noDataLabel: 'Não tenho projetos',
  ...
  award_v1: {
    en: {
      ...
      label: 'awards',
      noDataLabel: "I don't have awards",
  ...
  open_source_v1: {
    en: {
      ...
      label: 'open source',
      noDataLabel: "I don't have contributions",
    ...
    'pt-BR': {
      ...
      label: 'open source',
      noDataLabel: 'Não tenho contribuições',
  ...
  bug_bounty_v1: {
    en: {
      ...
      label: 'bug bounty',
      noDataLabel: "I don't have bug bounties",
    ...
    'pt-BR': {
      ...
      label: 'bug bounty',
      noDataLabel: 'Não tenho bug bounties',
  ...
  hackathon_v1: {
    en: {
      ...
      label: 'hackathons',
      noDataLabel: "I haven't done hackathons",
    ...
    'pt-BR': {
      ...
      label: 'hackathons',
      noDataLabel: 'Não participei de hackathons',
  ...
  talk_v1: {
    en: {
      ...
      label: 'talks',
      noDataLabel: "I don't have talks",
    ...
    'pt-BR': {
      ...
      label: 'palestras',
      noDataLabel: 'Não tenho palestras',
  ...
  achievement_v1: {
    en: {
      ...
      label: 'achievements',
      noDataLabel: "I don't have achievements",
    ...
    'pt-BR': {
      ...
      label: 'conquistas',
      noDataLabel: 'Não tenho conquistas',
  ...
  summary_v1: {
    en: {
      ...
      label: 'summary',
      noDataLabel: "I don't have a summary",
  ...
  interest_v1: {
    en: {
      ...
      label: 'interests',
      noDataLabel: "I don't have interests",
    ...
    'pt-BR': {
      ...
      label: 'interesses',
      noDataLabel: 'Não tenho interesses',
  ...
  recommendation_v1: {
    en: {
      ...
      noDataLabel: "I don't have recommendations",
    ...
    'pt-BR': {
      ...
      label: 'recomendações',
      noDataLabel: 'Não tenho recomendações',
