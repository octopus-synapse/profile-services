...
const SYSTEM_STYLES: readonly SystemStyleSeed[] = [
  {
    ...
    styleConfig: {
      ...
      tokens: {
        ...
        spacing: { density: 'comfortable', sectionGap: 'md', itemGap: 'md' },
      },
  ...
  },
  {
    ...
    styleConfig: {
      ...
      tokens: {
        ...
        spacing: { density: 'compact', sectionGap: 'sm', itemGap: 'sm' },
      },
      layout: { type: 'single-column', paperSize: 'a4', margins: 'narrow' },
    },
