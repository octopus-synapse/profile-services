...
export const MODERN_THEME = {
  ...
  styleConfig: {
    ...
    sections: [
      ...
      { id: 'project_v1', visible: true, order: 3, column: 'main' },
      { id: 'skill_set_v1', visible: true, order: 4, column: 'sidebar' },
      { id: 'education_v1', visible: true, order: 5, column: 'sidebar' },
      { id: 'language_v1', visible: true, order: 6, column: 'sidebar' },
      { id: 'certification_v1', visible: true, order: 7, column: 'sidebar' },
    ],
  },
};
